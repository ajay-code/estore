    ...
    <div class="carousel-inner z-depth-2" role="listbox">
        ...
        <div class="item active" id="tf-home">
            <div class="view overlay hm-blue-slight">
                <a><img src="{{asset('src/public/images/slider/main_2.jpg')}}" alt="Shopify Welcome">
        ...
        <div class="item" id="tf-home">
            <div class="view overlay hm-blue-slight">
                <a><img src="{{asset('src/public/images/slider/iPhone_1.jpg')}}" alt="iPhone 6s">
                    <div class="mask waves-effect waves-light"></div>
                </a>
                <div class="carousel-caption hidden-xs">
                    <div class="animated fadeInDown">
        ...
        <div class="item" id="tf-home">
            <div class="view overlay hm-blue-slight">
                <a><img src="{{asset('src/public/images/slider/Xbox_Controller_2.jpg')}}" alt="Xbox One Elite Controller">
                    <div class="mask waves-effect waves-light"></div>
                </a>
                <div class="carousel-caption hidden-xs">
                    <div class="animated fadeInDown">
        ...
        <div class="item" id="tf-home">
            <div class="view overlay hm-blue-slight">
                <a><img src="{{asset('src/public/images/slider/Astro_3.jpg')}}" alt="Astros">
                    <div class="mask waves-effect waves-light"></div>
                </a>
                <div class="carousel-caption hidden-xs">
                    <div class="animated fadeInDown">
